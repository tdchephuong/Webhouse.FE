    ...
    <div className="container mx-auto bg-white rounded-lg shadow-md relative mt-6 mb-24 px-1.5 lg:px-0">
      <div className="sm:flex">
        <div className="sm:w-1/2 sm:mt-0 mt-8 p-2 lg:p-16">
          <div className="text-4xl text-black contact-title font-medium">
            Get in touch
          </div>
          <div className="mt-2">
          ...
          <form>
            ...
            <div className="mt-6">
              ...
              <input
                ...
                id="contact-email"
                type="text"
                placeholder="Template code or some note"
              />
            </div>
            <NavLink
              to="/"
      ...
      <div className="absolute w-px h-full top-0 left-1/2 border-l border-default hidden lg:block" />
    </div>
  );
};
