        ...
        <div className="flex flex-col items-center mt-16 pb-24">
          <div className="flex text-gray-700">
            <div className=" mr-1 flex justify-center items-center cursor-pointer">
              <img className="transform rotate-180 w-6 h-6" src={iconDoubleArrowRightActive} alt=""/>
            </div>
            <div className=" mr-1 flex justify-center items-center cursor-pointer">
              <img className="transform rotate-180 w-6 h-6" src={iconRightArrowActive} alt=""/>
            </div>
            <div className="flex text-2xl">
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in text-active-default">1</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">2</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">3</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">4</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">5</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">...</div>
              <div className="px-3 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in">12</div>
            </div>
